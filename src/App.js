...
class App extends Component {
  ...
  this.state = {
    currentUser: {
      userName: "bob",
      memberSince: '1950'// set to state
    },
    debits: [],
    credits: []// set empty array 


    }  
  }

  //Making request with axios to API
  getDebits = () => {
  ...
  calculateAccountBalance = () => {
    ...
    // takes in two args- total dred and callback. for each credit in array, add total credit to array
  ...
  componentWillMount() {
    this.getDebits()
    this.getCredits()// getting info of debits from API
  }
  render () {
